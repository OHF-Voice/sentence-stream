"""Golden rules for English from pySBD.
...
GOLDEN_EN_RULES = [
    ...
    (True, "Hello World. My name is Jonas.", ["Hello World.", "My name is Jonas."]),
    ...
    (True, "There it is! I found it.", ["There it is!", "I found it."]),
    # 4) One letter upper case abbreviations
    (True, "My name is Jonas E. Smith.", ["My name is Jonas E. Smith."]),
    # 5) One letter lower case abbreviations
    (True, "Please turn to p. 55.", ["Please turn to p. 55."]),
    # 6) Two letter lower case abbreviations in the middle of a sentence
    (True, "Were Jane and co. at the party?", ["Were Jane and co. at the party?"]),
    ...
    (True, "That is JFK Jr.'s book.", ["That is JFK Jr.'s book."]),
    # 13) Multi-period abbreviations in the middle of a sentence
    (True, "I visited the U.S.A. last year.", ["I visited the U.S.A. last year."]),
    ...
    (True, "She has $100.00 in her bag.", ["She has $100.00 in her bag."]),
